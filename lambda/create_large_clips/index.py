...
def lambda_handler(event, context):
    ...
    if 1==1:
      ...
      #bucket='artifact-sport';
      prefix='High';postfix='mp4'
      ...
      mp4files = [file['Key'] for file in filelist if file['Key'][-3:]==postfix if file['Key'][:4]==prefix]
    ...
    if 1==1:
      for key in mp4files[:]:
          ...
          if counter<150:
            ...
            data["Settings"]["OutputGroups"][0]["CustomName"]='final'+str(counter)
            print(data["Settings"])
    ...
    return json.dumps({"fileschanged":mp4files,"large_clip_counter":large_clip_counter})
